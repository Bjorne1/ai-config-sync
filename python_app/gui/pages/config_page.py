...
class ConfigPage(QWidget):
    ...
    def _build_base_card(self) -> QWidget:
        ...
        form.addRow("Skills 源目录", self.skills_source)
        form.addRow("Commands 源目录", self.commands_source)
    ...
    def _build_environment_card(self) -> QWidget:
        ...
        form.addRow("发行版", self.wsl_distro)
        form.addRow("主目录", self.wsl_home)
        form.addRow("错误", self.wsl_error)
        card.body_layout.addLayout(form)
